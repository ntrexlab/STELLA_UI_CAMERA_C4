...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_robot_connect = wx.ToggleButton(self.tab_map, wx.ID_ANY, _("Connect"))
	...
	def __set_properties(self):
		...
		self.SetTitle(_("STELLA User Interface"))
	...
	def OnCameraConnect(self, event):  # wxGlade: MyFrame.<event_handler>
		print ("Event handler 'OnCameraConnect' not implemented!")
		event.Skip()

	def OnCameraShow(self, event):  # wxGlade: MyFrame.<event_handler>
		print ("Event handler 'OnCameraShow' not implemented!")
		event.Skip()
